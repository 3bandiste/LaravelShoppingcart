...
namespace EricTromas\Tests\Shoppingcart;

use Mockery;
use PHPUnit\Framework\Assert;
use EricTromas\Shoppingcart\Cart;
use Orchestra\Testbench\TestCase;
use Illuminate\Auth\Events\Logout;
use Illuminate\Support\Collection;
use EricTromas\Shoppingcart\CartItem;
use Illuminate\Support\Facades\Event;
use Illuminate\Session\SessionManager;
use Illuminate\Contracts\Auth\Authenticatable;
use EricTromas\Shoppingcart\ShoppingcartServiceProvider;
use EricTromas\Tests\Shoppingcart\Fixtures\ProductModel;
use EricTromas\Tests\Shoppingcart\Fixtures\BuyableProduct;
...
class CartTest extends TestCase
{
    ...
    /**
     * @test
     * @expectedException \EricTromas\Shoppingcart\Exceptions\InvalidRowIDException
     */
    ...
    /**
     * @test
     * @expectedException \EricTromas\Shoppingcart\Exceptions\UnknownModelException
    ...
    /**
     * @test
     * @expectedException \EricTromas\Shoppingcart\Exceptions\CartAlreadyStoredException
     ...
     *
     * @return \EricTromas\Shoppingcart\Cart
     */
